...
export default function EmployeePage() {
  ...
  async function fetchDropdowns() {
    try {
      ...
      setDesignations(
        Array.isArray(designationsRes.data)
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400">
                Register and manage organization staff members
              </p>
            </div>
          </div>
          <button
                      ...
                      <div className="grid gap-3">
                        <Field label="Employee #Code">
                          <input
                            ...
                            disabled
                            value={
                              editId ? `EMP-ID-${editId}` : "Auto Generated"
                            }
                            className="h-8 w-full rounded-md border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 px-2.5 text-[12px] font-mono text-slate-400 dark:text-slate-500 cursor-not-allowed"
                          />
                        </Field>
                        ...
                        <Field label="Company">
                          <div className="relative">
                            <select
                              ...
                              onChange={(e) =>
                                updateField("companyId", e.target.value)
                              }
                              className={selectCls}
                            >
                        ...
                        <Field label="Designation">
                          <div className="relative">
                            <select
                              ...
                              onChange={(e) =>
                                updateField("designationId", e.target.value)
                              }
                              className={selectCls}
                            >
                ...
                <tbody className="divide-y divide-slate-50 dark:divide-slate-800 bg-white dark:bg-slate-900 transition-colors">
                  {employees.map((emp) => (
                    <motion.tr
                      ...
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className={`group transition-colors hover:bg-teal-50/30 dark:hover:bg-teal-900/10 ${editId === emp.id ? "bg-teal-50/50 dark:bg-teal-900/20" : ""}`}
                    >
                      <td className="px-5 py-4">
                        <span className="font-mono text-[11px] font-bold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30 px-2 py-0.5 rounded-md">
                          {emp.employee_code}
                        </span>
                      </td>
                      <td className="px-5 py-4">
