...
import {
  ...
  StatCardSkeleton,
  TableSkeleton,
} from "../components/ui/Loaders.jsx";
  ...
  return (
    <div className="app-card group bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-4 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 relative overflow-hidden">
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div
          className={`w-8 h-8 rounded-xl ${bg} dark:bg-white/10 ${text} dark:text-white flex items-center justify-center`}
        >
...
export default function Dashboard() {
    ...
    try {
      ...
      if (showBookings) {
        setOrderStatus({
          ...
          completed: bList.filter((b) => b.booking_status === "Completed")
            .length,
  ...
  const hasAnyAccess =
    showCustomers || showProducts || showStaff || showSales || showBookings;
              ...
              {showBookings ? (
                <SectionCard
                  ...
                  action={
                    <button
                      onClick={() =>
                        (window.location.href = "/booking-customers")
                      }
