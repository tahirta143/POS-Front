          ...
          {isFormOpen && (
            ...
            >
              <Card className="mx-auto max-w-5xl border-l-[6px] border-l-teal-500 p-6 mb-6">
                ...
                <SectionCard title="Authorisation">
                  <div className="mt-1 grid gap-4 lg:grid-cols-3">
                        ...
                        >
                          ...
                          {invoices.map((inv) => (
                            <option key={inv.id} value={inv.id}>
                              {inv.receipt_no} - {inv.customer_name}
                            </option>
                          ))}
                        </select>
                    ...
                    {selectedInvoice && (
                      <div className="flex flex-col justify-center rounded-xl bg-teal-50 dark:bg-teal-900/20 px-4 py-2 border border-teal-100 dark:border-teal-900/50">
                        <p className="text-[10px] font-bold text-teal-600 dark:text-teal-400 uppercase tracking-widest">
                          Total Credit
                        </p>
                        <p className="text-lg font-black text-teal-700 dark:text-teal-300 truncate font-mono">
                ...
                {selectedInvoice && (
                  ...
                  >
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="flex items-center gap-3 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 px-3 py-2">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white dark:bg-slate-800 text-slate-400 border border-slate-100 dark:border-slate-700">
                      ...
                      <div className="flex items-center gap-3 rounded-xl border border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 px-3 py-2">
                        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white dark:bg-slate-800 text-slate-400 border border-slate-100 dark:border-slate-700">
                          <MdPriceCheck className="h-5 w-5" />
                        </div>
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">
                            Invoice Reference
                        ...
                        <tbody className="divide-y divide-slate-50 dark:divide-slate-800 bg-white dark:bg-slate-900 transition-colors">
                          {returnItems.map((item) => {
                            ...
                            return (
                              <tr
                                key={item.uniqueId}
                                className="hover:bg-slate-50/50 dark:hover:bg-teal-900/10"
                              >
                                ...
                                <td className="px-4 py-3 text-right font-mono dark:text-slate-300">
                                ...
                                <td className="px-4 py-3 text-center">
                                  <input
                                    ...
                                    className="h-8 w-20 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-2 text-center font-bold text-teal-700 dark:text-teal-400 focus:border-teal-400 outline-none"
                                  />
                                </td>
                                <td className="px-4 py-3 text-right font-black text-teal-700 dark:text-teal-400">
          ...
          <SectionHeader
            ...
            action={
              <div className="p-4">
                ...
                >
                  <MdRefresh className="inline mr-1" /> Refresh Records
                </button>
              </div>
            }
          />
                      ...
                      <td className="px-5 py-4">
                        <div className="flex flex-col">
                          <span className="text-[12px] font-semibold text-slate-600">
                            {record.invoice_ref || record.sale_invoice_id}
                          </span>
