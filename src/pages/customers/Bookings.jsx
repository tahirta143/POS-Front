...
export default function Bookings() {
  ...
  const isPartiallyPaid =
    payable > 0 && Number(givenAmount) > 0 && Number(givenAmount) < payable;
                        ...
                        {payable > 0 && givenAmount > 0 && (
                          ...
                          >
                            ...
                            >
                              PKR{" "}
                              {isAllPaid
                                ? (givenAmount - payable).toLocaleString()
              ...
              >
                <div className="bg-teal-600 p-4 text-white">
                  ...
                  <p className="text-xs text-teal-100">
                    Booking #BK-{payBooking.id} — {payBooking.customer_name}
                  </p>
                </div>
                <form onSubmit={handleRecordPayment} className="p-6 space-y-4">
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    <button
                      ...
                      className="flex-[2] rounded-xl bg-teal-600 py-2.5 text-sm font-bold text-white shadow-lg shadow-teal-100 hover:bg-teal-700 transition"
                    >
