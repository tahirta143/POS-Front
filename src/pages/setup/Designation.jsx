    ...
    <PageShell>
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-slate-900">Designations</h1>
            <p className="text-sm text-slate-500">Create and manage employee designations and job titles.</p>
          </div>
          <button
            onClick={() => {
              ...
              <table className="min-w-full divide-y divide-slate-100 text-left">
                ...
                <tbody className="divide-y divide-slate-50 bg-white">
                  {designations.map((d, i) => (
                    ...
                    >
                      <td className="px-5 py-4 text-[11px] text-slate-400 font-mono">{i + 1}</td>
                      <td className="px-5 py-4 font-bold text-slate-800">{d.designation_name}</td>
                      <td className="px-5 py-4 text-slate-500 text-[11px] max-w-xs truncate">{d.description || '—'}</td>
