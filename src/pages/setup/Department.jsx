      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">Create and manage company departments for organization.</p>
          </div>
          <button
            onClick={() => {
                ...
                <tbody className="divide-y divide-slate-50 bg-white">
                  {departments.map((d, i) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4 font-bold text-slate-800">{d.department_name}</td>
